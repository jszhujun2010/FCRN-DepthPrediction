...
class ResnetFCNLayer(caffe.Layer):
    ...
    def reshape(self, bottom, top):
        ...
        self.mask = self.load_mask(self.indices[self.idx])
        # reshape tops to fit (leading 1 is for batch dimension)
        top[0].reshape(1, *self.data.shape)
        top[1].reshape(1, *self.label.shape)
        top[2].reshape(1, *self.mask.shape)
    ...
    def load_image(self, idx):
        ...
        """
	data = io.imread('{}/full_data/{}.png'.format(self.dir_, idx))
    ...
    def load_label(self, idx, label_type=None):
        ...
        """
	data = io.imread('{}/full_label/{}.png'.format(self.dir_, idx))
