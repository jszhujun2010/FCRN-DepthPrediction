...
class ResnetFCNLayer_test(caffe.Layer):
    """
	...
	self.data = []
	self.label = []
	for i in range(self.idx, self.idx+self.batch_size):
		self.data.append(self.load_image(self.indices[i]))
		self.label.append(self.load_label(self.indices[i]))
    ...
    def load_image(self, idx):
        ...
        """
	data = io.imread('{}/test_image/{}.png'.format(self.dir_, idx))
    ...
    def load_label(self, idx, label_type=None):
        ...
        """
	data = scipy.io.loadmat('{}/test_label/{}.mat'.format(self.dir_, idx))['label']
